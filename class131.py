...
Original file is located at
    https://colab.research.google.com/drive/110fQDEONI9LgG0BCOiRduPlw-VGQWCT1
"""
...
for planet_data in planet_data_rows:
  ...
  radius.append(planet_data[7])
  name.append(planet_data[1])

for index,name in enumerate(name):
  gravity=(float(mass[index])*5.972e+24)/(float(radius[index])*float(radius[index])*6371000)*6.674e-11
  planet_gravity.append(gravity)

fig=px.scatter(x=radius,y=mass,size=planet_gravity)
fig.show()
